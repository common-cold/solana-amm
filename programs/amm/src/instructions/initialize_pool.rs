...
pub struct InitializePool<'info> {
    ...
    #[account(
        ...
        mint::authority = pool_account.key(),
        mint::freeze_authority = pool_account.key(),
        extensions::metadata_pointer::authority = pool_account.key(),
...
impl<'info> InitializePool<'info> {
    pub fn process(&mut self, amm_id: [u8; 12], token_name: String, token_symbol: String, pool_account_bump: u8) -> Result<()> {
        ...
        let token_metadata_ctx = CpiContext::new_with_signer(
            ...
            TokenMetadataInitialize {
                ...
                update_authority: self.pool_account.to_account_info(),
                mint_authority: self.pool_account.to_account_info(),
