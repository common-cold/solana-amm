...
// import { fundWallet, initMint, makeTokenwithMetaData } from "./utils";
...
//     [Buffer.from("lp_token"), poolAccount.toBuffer()], programId 
//   )[0];
...
//   makeTokenwithMetaData(svm, LPTokenMintAccount, poolAccount, mintOwner, program.provider.wallet.payer);
